...
{{< alert title="Tip" color="info">}}
This test would create a `GameServer` resource and delete it afterwards. In order to use `helm test` command described in this section you need to set `helm.installTests` helm parameter to `true`.
{{< /alert >}}
